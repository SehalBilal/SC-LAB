...
import controller.TimetableCoordinatorDashboardController;
import java.io.File;

public class TimetableCoordinatorDashboardView extends JFrame {
    private JButton[] menuButtons;
    private String[] buttonLabels = {
        "Check Timetable Conflict", "Change Class Schedule", "Logout"
    };
    private String[] iconFiles = {
        "checkconflict.png", "changeschedule.png", "logout.png"
    };
    private JPanel contentPanel;
    private int activeIndex = 0;
    private TimetableCoordinatorDashboardController controller;

    public TimetableCoordinatorDashboardView(TimetableCoordinatorDashboardController controller) {
        this.controller = controller;
        setTitle("Timetable Coordinator Console");
        ...
        leftPanel.add(Box.createRigidArea(new Dimension(16, 0)));
        JLabel consoleLabel = new JLabel("TIMETABLE COORDINATOR CONSOLE");
        ...
        for (int i = 0; i < buttonLabels.length; i++) {
            ...
            if (buttonLabels[i].equals("Check Timetable Conflict")) {
                btn.setIcon(new ImageIcon(new ImageIcon(System.getProperty("user.dir") + File.separator + "checktimetableconflicts.png").getImage().getScaledInstance(48, 48, Image.SCALE_SMOOTH)));
            } else if (buttonLabels[i].equals("Change Class Schedule")) {
                btn.setIcon(new ImageIcon(new ImageIcon(System.getProperty("user.dir") + File.separator + "resolvetimetable.png").getImage().getScaledInstance(48, 48, Image.SCALE_SMOOTH)));
            } else {
